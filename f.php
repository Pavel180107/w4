    ...
    <form method="post" action="index.php">
        ...
        <div class="form-group">
            ...
            <input type="text" id="full_name" name="full_name"
                   ...
                   <?= !empty($errors['full_name']) ? 'style="border-color: #8b3a3a;"' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone" name="phone"
                   ...
                   <?= !empty($errors['phone']) ? 'style="border-color: #8b3a3a;"' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email"
                   ...
                   <?= !empty($errors['email']) ? 'style="border-color: #8b3a3a;"' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="date" id="birth_date" name="birth_date"
                   ...
                   <?= !empty($errors['birth_date']) ? 'style="border-color: #8b3a3a;"' : '' ?>>
            ...
            <div class="radio-group">
                <label>
                    <input type="radio" name="gender" value="male"
                        ...
                        <?= !empty($errors['gender']) ? 'style="outline: 2px solid #8b3a3a;"' : '' ?>>
                    Мужской
                </label>
                <label>
        ...
        <div class="form-group">
            ...
            <select id="languages" name="languages[]" multiple size="6"
                    <?= !empty($errors['languages']) ? 'style="border-color: #8b3a3a;"' : '' ?>>
        ...
        <div class="form-group">
            ...
            <textarea id="biography" name="biography" rows="6"
                      <?= !empty($errors['biography']) ? 'style="border-color: #8b3a3a;"' : '' ?>><?= htmlspecialchars($values['biography'] ?? '') ?></textarea>
        ...
        <div class="form-group checkbox">
            <label>
                <input type="checkbox" name="contract_accepted" value="1"
                    ...
                    <?= !empty($errors['contract_accepted']) ? 'style="outline: 2px solid #8b3a3a;"' : '' ?>>
